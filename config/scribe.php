...
return [
    ...
    'routes' => [
        [
            ...
            // Exclude mutating verbs from response-call generation (they require auth + a real user;
            // Scribe can't authenticate, so it would crash). Docs still list them; examples come from @response tags.
            'exclude' => ['PUT *', 'PATCH *'],
        ],
    ],
    ...
    'auth' => [
        ...
        'extra_info' => 'Get your token from `POST /api/v1/login` (Authorization: Bearer <token>).',
    ],
