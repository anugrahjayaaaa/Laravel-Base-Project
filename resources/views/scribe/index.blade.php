    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="api-tokens">
                    <a href="#api-tokens">API Tokens</a>
                                    ...
                                    <ul id="tocify-subheader-api-tokens" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="api-tokens-GETapi-v1-api-tokens">
                                <a href="#api-tokens-GETapi-v1-api-tokens">List tokens (plain token shown only on creation).</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="api-tokens-POSTapi-v1-api-tokens">
                                <a href="#api-tokens-POSTapi-v1-api-tokens">Create a token. Returns the plain token ONCE.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="api-tokens-DELETEapi-v1-api-tokens--token-">
                                <a href="#api-tokens-DELETEapi-v1-api-tokens--token-">Revoke a token.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="audit">
                    <a href="#audit">Audit</a>
                                    ...
                                    <ul id="tocify-subheader-audit" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="audit-GETapi-v1-audit">
                                <a href="#audit-GETapi-v1-audit">List audit entries (filter by ?action=, ?causer=, ?from=, ?to=).</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="audit-GETapi-v1-audit-actions">
                                <a href="#audit-GETapi-v1-audit-actions">Available action types (for filter dropdowns).</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="auth">
                    <a href="#auth">Auth</a>
                                ...
                                <a href="#auth-POSTapi-v1-forgot-password">Send a password reset link.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="auth-POSTapi-v1-reset-password">
                                <a href="#auth-POSTapi-v1-reset-password">Reset password using a valid token.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="auth-GETapi-v1-email-verify">
                                <a href="#auth-GETapi-v1-email-verify">Verify email with the signed verification URL token.</a>
                            </li>
                                ...
                                <a href="#auth-POSTapi-v1-logout">POST api/v1/logout</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="auth-POSTapi-v1-password-change">
                                <a href="#auth-POSTapi-v1-password-change">POST api/v1/password/change</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="auth-POSTapi-v1-email-verify-resend">
                                <a href="#auth-POSTapi-v1-email-verify-resend">Resend the email verification link.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="features">
                    <a href="#features">Features</a>
                                    ...
                                    <ul id="tocify-subheader-features" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="features-GETapi-v1-features">
                                <a href="#features-GETapi-v1-features">List all feature flags.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="features-POSTapi-v1-features--slug--toggle">
                                <a href="#features-POSTapi-v1-features--slug--toggle">Toggle a feature flag.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="notifications">
                    <a href="#notifications">Notifications</a>
                                ...
                                <a href="#notifications-GETapi-v1-notifications">List notifications (paginated). Marks all as read on view.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="notifications-GETapi-v1-notifications-unread-count">
                                <a href="#notifications-GETapi-v1-notifications-unread-count">Unread notification count.</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="permissions">
                    <a href="#permissions">Permissions</a>
                                    ...
                                    <ul id="tocify-subheader-permissions" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="permissions-GETapi-v1-permissions">
                                <a href="#permissions-GETapi-v1-permissions">GET api/v1/permissions</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="permissions-POSTapi-v1-permissions">
                                <a href="#permissions-POSTapi-v1-permissions">POST api/v1/permissions</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="permissions-GETapi-v1-permissions--id-">
                                <a href="#permissions-GETapi-v1-permissions--id-">GET api/v1/permissions/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="permissions-DELETEapi-v1-permissions--id-">
                                <a href="#permissions-DELETEapi-v1-permissions--id-">DELETE api/v1/permissions/{id}</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="profile">
                    <a href="#profile">Profile</a>
                                ...
                                <a href="#profile-GETapi-v1-profile">Show own profile.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="profile-POSTapi-v1-profile-password">
                                <a href="#profile-POSTapi-v1-profile-password">Change own password (revokes all tokens + other devices).</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="roles">
                    <a href="#roles">Roles</a>
                                ...
                                <a href="#roles-GETapi-v1-roles">GET api/v1/roles</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="roles-POSTapi-v1-roles">
                                <a href="#roles-POSTapi-v1-roles">POST api/v1/roles</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="roles-GETapi-v1-roles--id-">
                                <a href="#roles-GETapi-v1-roles--id-">GET api/v1/roles/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="roles-DELETEapi-v1-roles--id-">
                                <a href="#roles-DELETEapi-v1-roles--id-">DELETE api/v1/roles/{id}</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="sessions">
                    <a href="#sessions">Sessions</a>
                                    ...
                                    <ul id="tocify-subheader-sessions" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="sessions-GETapi-v1-sessions">
                                <a href="#sessions-GETapi-v1-sessions">List active sessions.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="sessions-POSTapi-v1-sessions-logout-others">
                                <a href="#sessions-POSTapi-v1-sessions-logout-others">Log out all other sessions.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="users">
                    <a href="#users">Users</a>
                                ...
                                <a href="#users-GETapi-v1-users">List users (paginated, optional ?q= search).</a>
                            </li>
                                ...
                                <a href="#users-GETapi-v1-users--id-">Show a single user.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="users-DELETEapi-v1-users--id-">
                                <a href="#users-DELETEapi-v1-users--id-">Soft-delete a user.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="users-POSTapi-v1-users--user--lock">
                                <a href="#users-POSTapi-v1-users--user--lock">Permanently lock an account.</a>
                            </li>
...
<p>Get your token from <code>POST /api/v1/login</code> (Authorization: Bearer <token>).</p>

        <h1 id="api-tokens">API Tokens</h1>

    <p>Personal access tokens (Sanctum) for the authenticated user.</p>

                                <h2 id="api-tokens-GETapi-v1-api-tokens">List tokens (plain token shown only on creation).</h2>
...
<span id="example-requests-GETapi-v1-api-tokens">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/api-tokens" \
...
<span id="example-responses-GETapi-v1-api-tokens">
    </span>
<span id="execution-results-GETapi-v1-api-tokens" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-api-tokens"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-api-tokens"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-api-tokens" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-api-tokens">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-api-tokens" data-method="GET"
      data-path="api/v1/api-tokens"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-api-tokens', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-api-tokens"
                    onclick="tryItOut('GETapi-v1-api-tokens');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-api-tokens"
                    onclick="cancelTryOut('GETapi-v1-api-tokens');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-api-tokens"
            ...
            <b><code>api/v1/api-tokens</code></b>
        </p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-api-tokens"
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-api-tokens"
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-api-tokens"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="api-tokens-POSTapi-v1-api-tokens">Create a token. Returns the plain token ONCE.</h2>
...
<span id="example-requests-POSTapi-v1-api-tokens">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-api-tokens">
</span>
<span id="execution-results-POSTapi-v1-api-tokens" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-api-tokens"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-api-tokens"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-api-tokens" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-api-tokens">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-api-tokens" data-method="POST"
      data-path="api/v1/api-tokens"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-api-tokens', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-api-tokens"
                    onclick="tryItOut('POSTapi-v1-api-tokens');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-api-tokens"
                    onclick="cancelTryOut('POSTapi-v1-api-tokens');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-api-tokens"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-api-tokens"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-api-tokens"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-api-tokens"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-v1-api-tokens"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 100 characters. Example: <code>b</code></p>
                    ...
                    <h2 id="api-tokens-DELETEapi-v1-api-tokens--token-">Revoke a token.</h2>
...
<span id="example-requests-DELETEapi-v1-api-tokens--token-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request DELETE \
    "http://localhost:8000/api/v1/api-tokens/architecto" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-DELETEapi-v1-api-tokens--token-">
</span>
<span id="execution-results-DELETEapi-v1-api-tokens--token-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-api-tokens--token-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-api-tokens--token-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-api-tokens--token-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-api-tokens--token-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-api-tokens--token-" data-method="DELETE"
      data-path="api/v1/api-tokens/{token}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-api-tokens--token-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-api-tokens--token-"
                    onclick="tryItOut('DELETEapi-v1-api-tokens--token-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-api-tokens--token-"
                    onclick="cancelTryOut('DELETEapi-v1-api-tokens--token-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-api-tokens--token-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <b><code>api/v1/api-tokens/{token}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-v1-api-tokens--token-"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-api-tokens--token-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-api-tokens--token-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="token"                data-endpoint="DELETEapi-v1-api-tokens--token-"
               value="architecto"
               data-component="url">
    <br>
<p>Example: <code>architecto</code></p>
    ...
    <p>Audit log access (gated by <code>audit.view</code>).</p>

                                <h2 id="audit-GETapi-v1-audit">List audit entries (filter by ?action=, ?causer=, ?from=, ?to=).</h2>
...
<span id="example-requests-GETapi-v1-audit">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-v1-audit">
    </span>
<span id="execution-results-GETapi-v1-audit" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-audit"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-audit"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-audit" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-audit">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-audit" data-method="GET"
      data-path="api/v1/audit"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-audit', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-audit"
                    onclick="tryItOut('GETapi-v1-audit');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-audit"
                    onclick="cancelTryOut('GETapi-v1-audit');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-audit"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-audit"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-audit"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-audit"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="audit-GETapi-v1-audit-actions">Available action types (for filter dropdowns).</h2>
...
<span id="example-requests-GETapi-v1-audit-actions">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/audit/actions" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/audit/actions"
);
...
<span id="example-responses-GETapi-v1-audit-actions">
    </span>
<span id="execution-results-GETapi-v1-audit-actions" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-audit-actions"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-audit-actions"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-audit-actions" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-audit-actions">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-audit-actions" data-method="GET"
      data-path="api/v1/audit/actions"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-audit-actions', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-audit-actions"
                    onclick="tryItOut('GETapi-v1-audit-actions');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-audit-actions"
                    onclick="cancelTryOut('GETapi-v1-audit-actions');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-audit-actions"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/audit/actions</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-audit-actions"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-audit-actions"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-audit-actions"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
    ...
    <p>Authentication &amp; account endpoints (Sanctum Bearer token).</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="identifier"                data-endpoint="POSTapi-v1-login"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="auth-POSTapi-v1-forgot-password">Send a password reset link.</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="admin@laravel-base.local"
               data-component="body">
    <br>
<p>The user's email. Example: <code>admin@laravel-base.local</code></p>
        </div>
        </form>

                    <h2 id="auth-POSTapi-v1-reset-password">Reset password using a valid token.</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The reset token from the email. Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Min 8, confirmed. Example: <code>|]|{+-</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="auth-GETapi-v1-email-verify">Verify email with the signed verification URL token.</h2>
...
<span id="example-requests-GETapi-v1-email-verify">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/email/verify?id=16&amp;hash=architecto&amp;signature=architecto&amp;expires=16" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-v1-email-verify">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-email-verify" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-email-verify"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-email-verify"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-email-verify" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-email-verify">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-email-verify" data-method="GET"
      data-path="api/v1/email/verify"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-email-verify', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-email-verify"
                    onclick="tryItOut('GETapi-v1-email-verify');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-email-verify"
                    onclick="cancelTryOut('GETapi-v1-email-verify');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-email-verify"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-email-verify"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-email-verify"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-email-verify"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               step="any"               name="id"                data-endpoint="GETapi-v1-email-verify"
               value="16"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="hash"                data-endpoint="GETapi-v1-email-verify"
               value="architecto"
               data-component="query">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="signature"                data-endpoint="GETapi-v1-email-verify"
               value="architecto"
               data-component="query">
    <br>
<p>Signed URL signature. Example: <code>architecto</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="expires"                data-endpoint="GETapi-v1-email-verify"
               value="16"
               data-component="query">
    <br>
<p>optional Expiry timestamp. Example: <code>16</code></p>
            </div>
                </form>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="auth-POSTapi-v1-password-change">POST api/v1/password/change</h2>
...
<span id="example-requests-POSTapi-v1-password-change">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-password-change">
</span>
<span id="execution-results-POSTapi-v1-password-change" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-password-change"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-password-change"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-password-change" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-password-change">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-password-change" data-method="POST"
      data-path="api/v1/password/change"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-password-change', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-password-change"
                    onclick="tryItOut('POSTapi-v1-password-change');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-password-change"
                    onclick="cancelTryOut('POSTapi-v1-password-change');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-password-change"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/password/change</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-password-change"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-password-change"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-password-change"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<span id="example-requests-POSTapi-v1-email-verify-resend">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/email/verify/resend" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-email-verify-resend">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-email-verify-resend" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-email-verify-resend"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-email-verify-resend"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-email-verify-resend" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-email-verify-resend">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-email-verify-resend" data-method="POST"
      data-path="api/v1/email/verify/resend"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-email-verify-resend', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-email-verify-resend"
                    onclick="tryItOut('POSTapi-v1-email-verify-resend');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-email-verify-resend"
                    onclick="cancelTryOut('POSTapi-v1-email-verify-resend');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-email-verify-resend"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/email/verify/resend</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-email-verify-resend"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-email-verify-resend"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-email-verify-resend"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
    ...
    <p>Feature flags (gated by <code>feature.manage</code>).</p>

                                <h2 id="features-GETapi-v1-features">List all feature flags.</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-features"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="features-POSTapi-v1-features--slug--toggle">Toggle a feature flag.</h2>
...
<span id="example-requests-POSTapi-v1-features--slug--toggle">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/features/architecto/toggle" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-features--slug--toggle">
</span>
<span id="execution-results-POSTapi-v1-features--slug--toggle" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-features--slug--toggle"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-features--slug--toggle"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-features--slug--toggle" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-features--slug--toggle">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-features--slug--toggle" data-method="POST"
      data-path="api/v1/features/{slug}/toggle"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-features--slug--toggle', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-features--slug--toggle"
                    onclick="tryItOut('POSTapi-v1-features--slug--toggle');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-features--slug--toggle"
                    onclick="cancelTryOut('POSTapi-v1-features--slug--toggle');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-features--slug--toggle"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/features/{slug}/toggle</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-features--slug--toggle"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-features--slug--toggle"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-features--slug--toggle"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="slug"                data-endpoint="POSTapi-v1-features--slug--toggle"
               value="architecto"
               data-component="url">
    <br>
<p>The slug of the feature. Example: <code>architecto</code></p>
            </div>
                    </form>

                <h1 id="notifications">Notifications</h1>

    <p>Authenticated user's notifications.</p>

                                <h2 id="notifications-GETapi-v1-notifications">List notifications (paginated). Marks all as read on view.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="notifications-GETapi-v1-notifications-unread-count">Unread notification count.</h2>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>Permission management (admin).</p>

                                <h2 id="permissions-GETapi-v1-permissions">GET api/v1/permissions</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="permissions-POSTapi-v1-permissions">POST api/v1/permissions</h2>
...
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
                    ...
                    <h2 id="permissions-GETapi-v1-permissions--id-">GET api/v1/permissions/{id}</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-permissions--id-"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="GETapi-v1-permissions--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the permission. Example: <code>1</code></p>
                    ...
                    <h2 id="permissions-DELETEapi-v1-permissions--id-">DELETE api/v1/permissions/{id}</h2>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="DELETEapi-v1-permissions--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the permission. Example: <code>1</code></p>
    ...
    <p>Authenticated user's own profile.</p>

                                <h2 id="profile-GETapi-v1-profile">Show own profile.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="profile-POSTapi-v1-profile-password">Change own password (revokes all tokens + other devices).</h2>
...
<span id="example-requests-POSTapi-v1-profile-password">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-profile-password">
</span>
<span id="execution-results-POSTapi-v1-profile-password" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-profile-password"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-profile-password"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-profile-password" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-profile-password">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-profile-password" data-method="POST"
      data-path="api/v1/profile/password"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-profile-password', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-profile-password"
                    onclick="tryItOut('POSTapi-v1-profile-password');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-profile-password"
                    onclick="cancelTryOut('POSTapi-v1-profile-password');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-profile-password"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-profile-password"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-profile-password"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-profile-password"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="current_password"                data-endpoint="POSTapi-v1-profile-password"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="password"                data-endpoint="POSTapi-v1-profile-password"
               value="]|{+-0pBNvYg"
               data-component="body">
    <br>
<p>Must be at least 12 characters. Example: <code>]|{+-0pBNvYg</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="password_confirmation"                data-endpoint="POSTapi-v1-profile-password"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
    ...
    <p>Role management (admin).</p>

                                <h2 id="roles-GETapi-v1-roles">GET api/v1/roles</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="roles-POSTapi-v1-roles">POST api/v1/roles</h2>
...
<p>Must match an existing stored value.</p>
                    ...
                    <h2 id="roles-GETapi-v1-roles--id-">GET api/v1/roles/{id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/roles/2" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the role. Example: <code>2</code></p>
            </div>
                    </form>

                    <h2 id="roles-DELETEapi-v1-roles--id-">DELETE api/v1/roles/{id}</h2>
...
<p>The ID of the role. Example: <code>2</code></p>
    ...
    <p>Active sessions for the authenticated user.</p>

                                <h2 id="sessions-GETapi-v1-sessions">List active sessions.</h2>
...
<form id="form-GETapi-v1-sessions" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-sessions');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-sessions"
                    onclick="cancelTryOut('GETapi-v1-sessions');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-sessions"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="sessions-POSTapi-v1-sessions-logout-others">Log out all other sessions.</h2>
...
<span id="example-requests-POSTapi-v1-sessions-logout-others">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/sessions/logout-others" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-sessions-logout-others">
</span>
<span id="execution-results-POSTapi-v1-sessions-logout-others" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-sessions-logout-others"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-sessions-logout-others"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-sessions-logout-others" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-sessions-logout-others">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-sessions-logout-others" data-method="POST"
      data-path="api/v1/sessions/logout-others"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-sessions-logout-others', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-sessions-logout-others"
                    onclick="tryItOut('POSTapi-v1-sessions-logout-others');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-sessions-logout-others"
                    onclick="cancelTryOut('POSTapi-v1-sessions-logout-others');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-sessions-logout-others"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/sessions/logout-others</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-sessions-logout-others"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-sessions-logout-others"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-sessions-logout-others"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
    ...
    <p>User management (admin). All actions require the matching <code>user.*</code> permission.</p>

                                <h2 id="users-GETapi-v1-users">List users (paginated, optional ?q= search).</h2>
...
<p>Must match an existing stored value.</p>
                    ...
                    <h2 id="users-GETapi-v1-users--id-">Show a single user.</h2>
...
<p>The ID of the user. Example: <code>1</code></p>
                    ...
                    <h2 id="users-DELETEapi-v1-users--id-">Soft-delete a user.</h2>
...
<p>The ID of the user. Example: <code>1</code></p>
                    ...
                    <h2 id="users-POSTapi-v1-users--user--lock">Permanently lock an account.</h2>
...
<span id="example-requests-POSTapi-v1-users--user--lock">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/users/1/lock" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-users--user--lock">
</span>
<span id="execution-results-POSTapi-v1-users--user--lock" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-users--user--lock"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-users--user--lock"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-users--user--lock" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-users--user--lock">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-users--user--lock" data-method="POST"
      data-path="api/v1/users/{user}/lock"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-users--user--lock', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-users--user--lock"
                    onclick="tryItOut('POSTapi-v1-users--user--lock');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-users--user--lock"
                    onclick="cancelTryOut('POSTapi-v1-users--user--lock');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-users--user--lock"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/users/{user}/lock</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-users--user--lock"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-users--user--lock"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-users--user--lock"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="user"                data-endpoint="POSTapi-v1-users--user--lock"
               value="1"
               data-component="url">
    <br>
<p>The user. Example: <code>1</code></p>
                    ...
                    <h2 id="users-POSTapi-v1-users--user--unlock">Unlock a locked account.</h2>
...
<span id="example-requests-POSTapi-v1-users--user--unlock">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/users/1/unlock" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-users--user--unlock">
</span>
<span id="execution-results-POSTapi-v1-users--user--unlock" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-users--user--unlock"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-users--user--unlock"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-users--user--unlock" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-users--user--unlock">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-users--user--unlock" data-method="POST"
      data-path="api/v1/users/{user}/unlock"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-users--user--unlock', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-users--user--unlock"
                    onclick="tryItOut('POSTapi-v1-users--user--unlock');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-users--user--unlock"
                    onclick="cancelTryOut('POSTapi-v1-users--user--unlock');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-users--user--unlock"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/users/{user}/unlock</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-users--user--unlock"
               value="Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-users--user--unlock"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-users--user--unlock"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="user"                data-endpoint="POSTapi-v1-users--user--unlock"
               value="1"
               data-component="url">
    <br>
<p>The user. Example: <code>1</code></p>
