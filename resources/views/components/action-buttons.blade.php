...
<div class="btn-group" role="group" aria-label="Actions">
    ...
    @endif
    @if ($restore)
        <a href="{{ $restore }}" class="btn btn-sm btn-light border text-success rounded-2" data-bs-toggle="tooltip" data-bs-title="{{ $restoreLabel }}" aria-label="{{ $restoreLabel }}" style="min-width:38px">
